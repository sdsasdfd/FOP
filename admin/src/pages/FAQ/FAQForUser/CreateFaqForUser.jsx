...
const CreateFaqForUser = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const res = await fetch("/api/faq/new/user", {
        method: "POST",
  ...
  return (
    <div className="flex justify-center  min-h-screen bg-slate-50 ">
      <div className=" bg-white p-4 w-[350px] h-[350px] my-4 flex shadow-md flex-col border rounded-md">
        <h1 className=" text-3xl font-semibold mb-3">New FAQ For User</h1>
...
export default CreateFaqForUser;
